...
When building or updating `frontend`, treat this prototype as the design spec: screen structure, component states (empty/loading/populated), copy, and the Modernist token values.
