...
class UnrevealChallengeServiceTest {
    ...
    @Test
    void should_unrevealChallengeBackToClosed_andPublishEvent_when_organizerRequests() {
        ...
        assertEquals(at.fraihs.cookoff.cookoff.domain.model.ChallengeStatus.CLOSED, challenge.getStatus());
